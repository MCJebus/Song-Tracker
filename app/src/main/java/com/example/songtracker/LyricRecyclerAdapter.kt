...
class LyricRecyclerAdapter(private val lyricModelArrayList: MutableList<Lyric>) : RecyclerView.Adapter<LyricRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txtMsg.setText(info.lyric)
        holder.txtMsg.setOnClickListener {v ->
            val snackbar = Snackbar.make(v, "You clicked on ${info.lyric}", Snackbar.LENGTH_LONG)
            snackbar.show()
        }
    }
